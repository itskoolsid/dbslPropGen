 ...
 * 
 * import addressbook.backend.Contact; import
 * addressbook.backend.ContactService;
 * 
 * import com.vaadin.annotations.Theme; import com.vaadin.annotations.Title;
 * import com.vaadin.annotations.VaadinServletConfiguration; import
 * com.vaadin.data.util.BeanItemContainer; import
 * com.vaadin.event.FieldEvents.TextChangeEvent; import
 * com.vaadin.event.FieldEvents.TextChangeListener; import
 * com.vaadin.event.SelectionEvent; import
 * com.vaadin.event.SelectionEvent.SelectionListener; import
 * com.vaadin.server.VaadinRequest; import com.vaadin.server.VaadinServlet;
 * import com.vaadin.ui.Button; import com.vaadin.ui.Button.ClickEvent; import
 * com.vaadin.ui.Button.ClickListener; import com.vaadin.ui.Grid; import
 * com.vaadin.ui.HorizontalLayout; import com.vaadin.ui.TextField; import
 ...
 * @Title("Addressbook")
 * 
 * @Theme("valo") public class AddressbookUI extends UI {
 * 
 * 
 ...
 * 
 * TextField filter = new TextField(); Grid contactList = new Grid(); Button
 * newContact = new Button("New contact");
 * 
 * // ContactForm is an example of a custom component class ContactForm
 * contactForm = new ContactForm();
 * 
 * // ContactService is a in-memory mock DAO that mimics // a real-world
 * datasource. Typically implemented for // example as EJB or Spring Data based
 * service. ContactService service = ContactService.createDemoService();
 * 
 * 
 * The "Main method".
 * 
 ...
 * 
 * @Override protected void init(VaadinRequest request) { configureComponents();
 * buildLayout(); }
 * 
 ...
 * 
 * @Override public void buttonClick(ClickEvent event) { contactForm.edit(new
 * Contact()); } });
 * 
 * filter.setInputPrompt("Filter contacts..."); filter.addTextChangeListener(new
 * TextChangeListener() {
 * 
 ...
 * contactList.removeColumn("id"); contactList.removeColumn("birthDate");
 ...
 * 
 * private void buildLayout() { HorizontalLayout actions = new
 * HorizontalLayout(filter, newContact); actions.setWidth("100%");
 * filter.setWidth("100%"); actions.setExpandRatio(filter, 1);
 * 
 * VerticalLayout left = new VerticalLayout(actions, contactList);
 * left.setSizeFull(); contactList.setSizeFull();
 * left.setExpandRatio(contactList, 1);
 * 
 * HorizontalLayout mainLayout = new HorizontalLayout(left, contactForm);
 * mainLayout.setSizeFull(); mainLayout.setExpandRatio(left, 1);
 * 
 * // Split and allow resizing setContent(mainLayout); }
 * 
 * 
 ...
 * 
 * void refreshContacts() { refreshContacts(filter.getValue()); }
 * 
 * private void refreshContacts(String stringFilter) {
 * contactList.setContainerDataSource(new BeanItemContainer<>(Contact.class,
 * service.findAll(stringFilter))); contactForm.setVisible(false); }
 * 
 * 
