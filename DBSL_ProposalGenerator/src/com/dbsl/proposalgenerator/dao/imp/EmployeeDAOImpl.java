...
import com.dbsl.proposalgenerator.commons.util.StaticValues;
import com.dbsl.proposalgenerator.dao.EmployeeDAO;
import com.vaadin.addon.jpacontainer.JPAContainer;
import com.vaadin.addon.jpacontainer.JPAContainerFactory;

public class EmployeeDAOImpl implements EmployeeDAO {
	String PERSISTENCE_UNIT = StaticValues.PERSISTENCE_UNIT;
	JPAContainer<Employee> empcontainer = JPAContainerFactory.make(
	...
	public Employee getEmployeeByName(String empName) {
		 ...
		 */
		Query query = em
				.createNativeQuery("SELECT * FROM Employee p WHERE p.firstName=:empName");
