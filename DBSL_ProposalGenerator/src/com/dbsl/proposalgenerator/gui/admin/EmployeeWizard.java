...
public class EmployeeWizard extends VerticalLayout implements WizardProgressListener {
    ...
    public EmployeeWizard() {
        ...
        Item privilegeItem = new BeanItem<Set<Privilege>>(employee.getPrivileges());
        ...
        wizard.addStep(new AddEmpPrivilegeStep(privilegeBinder, wizard), "empPrivilege");
        wizard.setSizeFull();
        addComponent(wizard);
    ...
    public void wizardCompleted(WizardCompletedEvent event) {
        System.out.println("************ " + employeeItem.getBean().getFirsName() + " :: "
                + employeeItem.getBean().getContact().getMobNo() + employeeItem.getBean().getAddress().getLine1());
        // empDAO.addEmployee(employeeItem.getBean());
        notifications.showNotification(this, "Vaadin", "http://www.vaadin.com", new ThemeResource("images/reindeer.png"));
    ...
    private void endWizard(String message) {
        ...
        Button startOverButton = new Button("Add another Employee", new Button.ClickListener() {
            @Override
